...
export class Init1751981392993 implements MigrationInterface {
    name = 'Init1751981392993'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`quote\` (\`id\` varchar(36) NOT NULL, \`exchange_rate\` decimal(18,8) NOT NULL, \`resulting_fiat_amount\` decimal(18,8) NOT NULL, \`timestamp\` timestamp NOT NULL, \`input_amount\` decimal(18,8) NOT NULL, \`fee\` decimal(18,8) NOT NULL, \`input_currency\` varchar(255) NOT NULL, \`output_currency\` varchar(255) NOT NULL, \`user_id\` varchar(36) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
